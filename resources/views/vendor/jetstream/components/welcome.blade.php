        ...
        <div class="flex flex-col flex-1 min-h-screen overflow-x-hidden overflow-y-auto">
          ...
          <header class="relative bg-white dark:bg-darker">
            <div class="flex items-center justify-between p-2 border-b dark:border-blue-800">
              ...
              >
                <!--can use to display logo or text  -->
              </a>
              ...
              <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                ...
                <div class="relative" x-data="{ open: false }">
                  ...
                  >
                    ...
                    <img class="w-10 h-10 rounded-full" src="https://i.pravatar.cc/300" alt="Ahmed Kamel" />
                  </button>
          ...
          <div class="flex flex-col h-screen">
            ...
            <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden font-sans h hover:overflow-y-auto">
              ...
              <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                  <img class="w-10 h-10 rounded-lg" src="https://i.pravatar.cc/300" alt="Post cover" />
                </div>
              ...
              <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                  <img class="w-10 h-10 rounded-lg" src="https://i.pravatar.cc/300" alt="Ahmed Kamel" />
                </div>
                <div class="flex-1 max-w-xs overflow-hidden">
              ...
              <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                  <img class="w-10 h-10 rounded-lg" src="https://i.pravatar.cc/300" alt="K-WD Dashboard" />
                </div>
                <div class="flex-1 max-w-xs overflow-hidden">
