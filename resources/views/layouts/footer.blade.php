...
<footer class="mt-10 h-10 text-gray-700 bg-white border-t body-font">
    <div class="border-t border-gray-200">
        <div class="container flex flex-col flex-wrap items-center justify-between p-5 mx-auto md:flex-row">
            ...
            <div class="inline-flex items-center justify-center md:justify-start ">
                <span class="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                    ...
                    <a class="ml-4 text-blue-870 hover:text-blue-500" href="https://twitter.com/p_trulli">
                        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            class="w-5 h-5" viewBox="0 0 24 24">
                            <path
        ...
        <div
            ...
            <p class="text-sm text-center text-gray-400 ">© O'Simply — 2020
            </p>
        </div>
    </div>
</footer>