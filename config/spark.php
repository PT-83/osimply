    ...
    'billables' => [
        ...
        'user' => [
            ...
            'plans' => [
                [
                    'name' => 'Hobby',
                    'short_description' => 'This plan is for new or intermidate stock holdings',
                    'monthly_id' =>'price_1INqrgHeeMkjowVd1iqdMKww',
                    'yearly_id' => 'price_1INqrgHeeMkjowVdpk3amk03',
                    'features' => [
                        'Bi-weekly Screen Shots',
                        'Monthly Reports',
                        'Tracks Maximun 5 Stocks',
                        'Email Suport'
                    ],
                    'archived' => false,
                ],
                ...
                [
                    'name' => 'Intermediate',
                    'short_description' => 'This plan is for intermidate amount of stock holdings',
                    'monthly_id' => 'price_1INqvIHeeMkjowVdlY8U9bqo',
                    'yearly_id' => 'price_1INqvIHeeMkjowVduOiIfQsH',
                    'features' => [
                        'Bi-weekly Screen Shots',
                        'Bi-weekly onthly Reports',
                        'Tracks Maximun 10 Stocks',
                        'Email Suport'
                    ],
                    'archived' => false,
                ],
                [
                    'name' => 'Professional',
                    'short_description' => 'This plan is for intermidate amount of stock holdings',
                    'monthly_id' => 'price_1INqwgHeeMkjowVdpfeXc9DA',
                    'yearly_id' => 'price_1INqwgHeeMkjowVdgdKELS1H',
                    'features' => [
                        'Bi-weekly Screen Shots',
                        'Bi-weekly onthly Reports',
                        'Tracks Maximun 10 Stocks',
